    ...
    <div class="modal-body">
        <div class='form-group'>
            <div class='row-filter-combo row'>
                @php
                    $skippedColumns = array ('pond_id', 'ebi_farms.farm_name', 'ebi_ponds.pond_name','ebi_aquacultures.estimate_shipping_date','ebi_farms.farm_name_en');
                @endphp
                <?php foreach($columns as $key => $col):?>
                <?php if (isset($col['image']) || isset($col['download']) || $col['visible'] === FALSE) continue;?>
                <?php if (in_array($col['field_with'], $skippedColumns)) continue;?>
                @if ($col['field_with'] == 'ebi_aquacultures.completed_date' || $col['field_with'] == 'ebi_aquacultures.start_date')
                    <div class="col-sm-2">
        ...
        <div class='form-group'>
            <div class='row-filter-combo row'>
                ...
                <?php endforeach;?>
                <div class='col-sm-2'>
                    <button class="btn btn-primary btn-submit" type="submit">{{trans("crudbooster.button_search")}}</button>
                </div>
            </div>
        </div>
    </div>
