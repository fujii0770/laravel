...
<head>
    ...
    <link href="{{ asset("css/ebi_iot.css")}}?v=4" rel="stylesheet" type="text/css"/>
    ...
    @if(!isset($ignoreFrontendCss) || !$ignoreFrontendCss)
        <link href="{{ asset("css/frontend.css")}}?v=5.3" rel="stylesheet" type="text/css"/>
    @endif
...
<body class="@php echo (Session::get('theme_color'))?:'skin-blue'; echo '_'; echo config('crudbooster.ADMIN_LAYOUT'); @endphp {{($sidebar_mode)?:''}}">
...
<!-- Content Wrapper. Contains page content -->
    <div class="{{isset($contentWrapperClass)?$contentWrapperClass:''}}">
        ...
        <section class="content-header">
            ...
            {{--<ol class="breadcrumb">
                ...
                <li class="active">
                    {{$module?$module->name.($page_sub_title?'［'.strip_tags($page_sub_title).'］':''):strip_tags($page_title)}}
                </li>
            </ol>--}}
        </section>
        {{--@if(CRUDBooster::getCurrentMethod() == 'getIndex' || (isset($index_button) && count($index_button)))
        ...
        <section id='content_section' class="content">
            ...
            @if (!Request::is('admin/shrimpMigration*') && Session::get('message')!='')
...
@yield('after_admin_template_plugins')
<!-- load js -->
@if($load_js)
