...
<header class="main-header">
    ...
    <!-- Logo -->
    <a href="{{url(config('crudbooster.ADMIN_PATH'))}}" title='{{__(Session::get('appname'))}}' class="logo">{{__(CRUDBooster::getSetting('appname'))}}</a>
...
--}}
                ...
                <li class="dropdown languages-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">LANGUAGE</a> <i class="fa fa-caret-down"></i>
                    <ul id='list_languages' class="dropdown-menu" style="min-width: 100px">
                        {{--<li>
                            <a href="{{CRUDBooster::adminPath('lang/en')}}">English</a>
                        </li>--}}
                        <li>
                            <a href="{{CRUDBooster::adminPath('lang/ja')}}">{{trans('ebi.日本語')}}</a>
                        </li>
                        <li>
                            <a href="{{CRUDBooster::adminPath('lang/en')}}">ENGLISH</a>
                        </li>
                ...
                <li class="dropdown user user-menu">
                    ...
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <span class="hidden-xs">{{ CRUDBooster::myName() }}</span> <i class="fa fa-caret-down"></i>
                    </a>
                    <style>
                        .dropdown a {
                            position: relative;
                            ...
                            <p>
                             ...
                             {{--   <small>{{ CRUDBooster::myPrivilegeName() }}</small>--}}
                                <small><em>@php
                                            ...
                                            IntlDateFormatter::NONE, 'Asia/Tokyo', IntlDateFormatter::GREGORIAN);
